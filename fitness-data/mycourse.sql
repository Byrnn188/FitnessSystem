...
CREATE TABLE `mycourse` (
  ...
  `lesson_instructor` varchar(1000) DEFAULT NULL,
  `lesson_time` varchar(1000) DEFAULT NULL,
  
  `user_id` int NOT NULL,
--  `lesson_size` varchar(5) NOT NULL DEFAULT 'M',

  PRIMARY KEY (`mycourse_id`),
  UNIQUE KEY `mycourse_mycourseID_uindex` (`mycourse_id`)
...
-- Dump completed on 2023-10-23 19:43:38
